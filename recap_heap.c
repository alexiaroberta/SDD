...
void filtreazaHeapMin(Heap heap, int pozRadacina) {
	...
	if (nodStanga < heap.dimensiune && heap.vector[nodStanga].grileGresite < heap.vector[pozMin].grileGresite) {//exista nod stanga si e mai mic decat radacina
		pozMin = nodStanga;
	}
	if (nodDreapta < heap.dimensiune && heap.vector[nodDreapta].grileGresite < heap.vector[pozMin].grileGresite) {//exista nod dreapta si  e mai mic decat radacina
		pozMin = nodDreapta;
	}
...
void filtreazaHeapMax(Heap heap, int pozRadacina) {
	...
	if (nodStanga < heap.dimensiune && heap.vector[nodStanga].grileGresite > heap.vector[pozMax].grileGresite) { //exista nod stanga si e mai mare decat radacina
		pozMax = nodStanga;
	}
	if (nodDreapta <heap.dimensiune && heap.vector[nodDreapta].grileGresite > heap.vector[pozMax].grileGresite) { //exista nod drapta si e mai mare decat radacina
		pozMax = nodDreapta;
	}
